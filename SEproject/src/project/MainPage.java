	...
	public MainPage() {
		...
		bt_member.addActionListener((e) -> {
			if (loginStatus == false) {
				...
				setPage(1);
				Member memberPage = (Member) pages[1];
				memberPage.getMemberList(null);
			}
		});
		...
		bt_trainer.addActionListener((e) -> {
			if (loginStatus == false) {
				...
				setPage(2);
				Trainer trainerPage = (Trainer) pages[2];
				trainerPage.getTrainerList(null);
			}
		...
		bt_program.addActionListener((e) -> {
			if (loginStatus == false) {
				...
				setPage(3);
				Program programPage = (Program) pages[3];
				programPage.getProgramList(null);
			}
		});
