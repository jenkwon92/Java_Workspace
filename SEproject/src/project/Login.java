	...
	public void login() {
		...
		try {
			...
			if (rs.next()) {
				...
				Member memberPage = (Member) mainPage.pages[1]; // **이거 추가
				memberPage.getMemberList(null); // **이거추가
			} else if (name.equals("") && pass.equals("")) {
				JOptionPane.showMessageDialog(this, "아이디와비밀번호를 입력해주세요");
			} else if (name.equals("")) {
				JOptionPane.showMessageDialog(this, "아이디를 입력해주세요");
			} else if (pass.equals("")) {
				JOptionPane.showMessageDialog(this, "비밀번호를 입력해주세요");
			} else {
				JOptionPane.showMessageDialog(this, "잘못된접근입니다.");
