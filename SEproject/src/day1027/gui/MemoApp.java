...
public class MemoApp extends JFrame{
	...
	JMenuItem[] items;
	String[] item_title = {"새로만들기","새 창","열기","저장","다른이름으로 저장","페이지설정","인쇄","끝내기"};
	JTextArea area;
	...
	public MemoApp() {
		...
		//아이템 생성
		//주의> 메뉴아이템이 생성된게 아니라 아이템이 들어갈 자리를 8칸 확보만한 상태
		//js와는 달리, 자바에서는 배열의 자료형이 이미 결정되면 해당자료형만 넣을 수 있음
		...
		area.setFont(new Font("돋움체",Font.BOLD|Font.ITALIC,20)); //Font객체를 사용하는 법을 나름 연구해보기 (1.용도파악 2.)
