 ...
 * 컴포넌트가 보여지도록 처리해보자! (그래픽 처리 관여..즉, 우리 주도하에 그림그리자)
 * */
...
public class PaintTest extends JFrame{
	...
	public PaintTest() {		
		...
		//캔버스에 그림을 그리려면, 캔버스가 스스로그리는 메서드인 .paint()메서드를 재정의
	...
	//Button, JFrame, Choice x ..거의다 방해하지말자 
	//그런데 컴포넌트 중 개발자가 주도해서 그림을 그릴수 없는 컴포넌트
