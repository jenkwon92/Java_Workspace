 ...
 * 데이터량이 많을 떄 너무 많은 입출력을 수행하게된다. 속도저하
 * 마치cmd 창의 버퍼 처리처럼 메모리상의 버퍼에 데이터를 모아놓고, 한줄이 끝나는 시점에만
 * 입력및 출력을 처리하면 프로그램 실행의 효율성이 극대화됨
...
public class BufferedIOApp {
	...
	public static void main(String[] args) {
		//keyboard에 연결된 스트림은 개발자가 원하는 타임에 new하 수 있다
