...
public class GalleryApp extends JFrame implements ActionListener{
	...
	JPanel p_center;
	JScrollPane scroll;
	JLabel la_name;//제목나올 라벨
	XCanvas can; //센터에 크게 나올 이미지를 그릴 캔버스
	JPanel p_south;
	JButton bt_prev,bt_next;
	
	
	ArrayList<Thumb> list = new ArrayList<Thumb>(); //썸네일 배열
	...
	public GalleryApp() {
		...
		bt_prev.addActionListener(this);//버튼과 리스너연결
		bt_next.addActionListener(this);//버튼과 리스너연결
